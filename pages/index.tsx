  ...
  return (
    <div>
      ...
      <div className="flex justify-center">
        <div className="bg-gradient-to-r from-[#D9DCDC] via-[#DFDFDF] to-[#D9DCDC] h-[70vh] w-screen">
          <div className="grid place-content-center ">
            <img
              className="object-none w-[60rem] h-[32rem] drop-shadow-[130px_100px_30px_#D2D2D2]"
              src="https://nextjs.org/_next/image?url=%2Fstatic%2Fconf-22%2Fprism-light-colorful.jpg&w=1080&q=100"
              alt=""
            />
            <div className="top-[32rem] -translate-y-1/2 absolute flex justify-center w-full mt-12">
              <div className="grid place-items-center">
                <div className="w-64 z-10 mb-6 grid content-center">
                  <svg
                ...
                <div className="tracking-[.05em] font-mono  mb-10">
                  Brought to you by Vercel
                </div>
                <div className="text-lg tracking-[.05em] font-mono mb-10">
                  An online experience developers love • October 25, 2022
                </div>
                <div className="flex gap-6 mb-14 font-mono">
                  <div className="grid place-items-center">
                    <div className="text-4xl mb-4">00</div>
                  ...
                  <div className="text-4xl">:</div>
                  <div className="grid place-items-center">
                    <div className="text-4xl mb-4">{sec}</div>
                    <div className="text-xs">Seconds</div>
                  </div>
                </div>
                <div>
                  <button className="bg-white py-3 px-8 rounded-full font-mono border border-black">
                    Register Now →
                  </button>
                </div>
              </div>
          ...
          <div className="h-[30vh] bg-gradient-to-b from-[#DADDDD] to-[#ffffff]"></div>
          <div className="container max-w-5xl mx-auto bg-white h-screen w-screen ">
            <div className="grid place-items-center h-[100vh] text-center pt-[30vh]">
              <div className="text-[100px] font-bold leading-[6rem] tracking-tighter">
                <h1>The React Framework for Production</h1>
              </div>
              <div className="text-xl text-[#696969] tracking-tighter">
              ...
              <div className="flex gap-6">
                <button className="px-14 py-3 bg-blue-500 rounded-xl text-white shadow-2xl hover:shadow-[0_15px_20px_5px_#DADDDD]">
                  Start Learning
                </button>
                <button className="px-14 py-3 bg-white rounded-xl shadow-2xl hover:shadow-[0_15px_20px_5px_#DADDDD] text-[#696969]">
                  Documentation
                </button>
              </div>
          ...
          <div className="container max-w-5xl mx-auto bg-white w-screen ">
            <div className="flex justify-center text-center pt-[20vh]">
              <div className="grid">
                <div className="text-[30px] font-bold">The Web SDK</div>
                <div className="pt-[4vh] text-[#696969]">
                  Next.js has all the tools you need to make the Web. Faster.
                </div>
              </div>
            </div>
            <div className="grid grid-cols md:grid-cols-2 xl:grid-cols-3 mt-10 gap-6">
              <div className="px-1 py-4 rounded overflow-hidden border hover:shadow-lg">
                ...
                <div className="ml-4 text-blue-500 hover:underline">
                  Documentation →
                </div>
              </div>
              <div className="px-1 py-4 rounded overflow-hidden border hover:shadow-lg">
            ...
            <div className="grid place-content-center">
              <div className="mt-10 mb-20">
                <b>And more:</b> Support for environment variables, preview mode,
                custom head tags, automatic polyfills, and more.
              </div>
            </div>
          </div>
        </div>
